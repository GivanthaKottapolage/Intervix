...
export default function InterviewForm() {
    ...
    const fieldClass =
        "w-full bg-[#eff4ff] border border-[#c2c6d4]/50 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#005db5]/20 focus:border-[#00488d] focus:bg-white transition-all placeholder:text-[#727783]";
