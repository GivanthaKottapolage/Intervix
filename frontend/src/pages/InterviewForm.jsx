...
export default function InterviewForm() {
    ...
    const fieldClass = "w-full bg-[#eff4ff] border border-[#c2c6d4]/50 rounded-lg px-4 py-2.5 placeholder:text-[#727783] focus:outline-none focus:ring-2 focus:ring-[#005db5]/20 focus:border-[#00488d] focus:bg-white transition-all";

    function addArea(value) {
        const trimmed = value.trim();
        if (trimmed && !areasToFocus.includes(trimmed)) {
            setAreasToFocus((prev) => [...prev, trimmed]);
        }
        setAreaInput("");
    }
    ...
    return (
        <div className="relative min-h-screen bg-[#eef2fb] text-[#0b1c30]">
            ...
            <div className="relative max-w-3xl mx-auto px-4 md:px-6 py-10 md:py-14">
                ...
                <div className="bg-white/70 backdrop-blur-xl border border-[#c2c6d4]/30 rounded-2xl shadow-xl p-6 md:p-9">
                    <div className="mb-7">
